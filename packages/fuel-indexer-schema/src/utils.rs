...
use graphql_parser::schema::{Definition, Directive, Document, Field, ObjectType, TypeDefinition};
...
pub fn get_index_directive(field: &Field<String>) -> Option<sql_types::directives::Index> {
    let Field {
        mut directives,
        name: field_name,
        ..
...
pub fn build_schema_fields_and_types_map(ast: &Document<String>) -> HashMap<String, String> {
...
pub fn build_schema_objects_set(ast: &Document<String>) -> (HashSet<String>, HashSet<String>) {
