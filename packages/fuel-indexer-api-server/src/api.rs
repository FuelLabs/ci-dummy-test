use crate::uses::{
    authorize_middleware, health_check, metrics, query_graph, register_index_assets, stop_index,
};
...
use fuel_indexer_schema::db::{graphql::GraphqlError, manager::SchemaManager, IndexerSchemaError};
