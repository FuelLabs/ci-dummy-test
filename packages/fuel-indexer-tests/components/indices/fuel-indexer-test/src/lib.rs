...
mod fuel_indexer_test {
    ...
    fn fuel_indexer_test_multiargs(pung: Pung, pong: Pong, ping: Ping, block_data: BlockData) {
        Logger::info(
    ...
    fn fuel_indexer_test_tuple(event: ComplexTupleStruct, logdata_entity: SimpleTupleStruct) {
        Logger::info(
            "fuel_indexer_test_tuple handling ComplexTupleStruct and SimpleTupleStruct events.",
        );
