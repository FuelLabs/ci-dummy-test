...
pub mod assets {
    pub const FUEL_INDEXER_TEST_MANIFEST: &str = include_str!("./../assets/fuel_indexer_test.yaml");
    pub const SIMPLE_WASM_MANIFEST: &str = include_str!("./../assets/simple_wasm.yaml");
    pub const BAD_SIMPLE_WASM_MANIFEST: &str = include_str!("./../assets/bad_simple_wasm.yaml");
    pub const BAD_SIMPLE_WASM_WASM: &[u8] = include_bytes!("./../assets/bad_simple_wasm.wasm");
